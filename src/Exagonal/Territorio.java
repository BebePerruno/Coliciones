...
public class Territorio extends javax.swing.JPanel {
    ...
    public void setImagen(ImageIcon nuevaImagen){
        ...
        imagen=nuevaImagen;
        jLbEventos.setIcon(imagen);//(new javax.swing.ImageIcon(getClass().getResource("/E_S/medieval_archery.png"))); 
    }
...
//    }
    ...
    public void setEventos(AbstractDoubleClick nuevoMouseListener){
        ...
        this.jLabel2.addMouseListener(nuevoMouseListener);
        ...
        this.jLabel2.addMouseMotionListener(nuevoMouseListener);
    ...
    /**
     * No sirve aqui porque todas las instancias poseen estos mismos JLabels.
     * Entonces debe programarse en el contenedor form.
     * @return 
     */
    public boolean estaSeleccionado(){
        try{
            if (this.jLabel2.getBounds().intersects(rectanguloPuntero)==true){return true;}
            if (this.jLabel6.getBounds().intersects(rectanguloPuntero)==true){return true;}
            if (this.jLabel7.getBounds().intersects(rectanguloPuntero)==true){return true;}
            if (this.jLabel8.getBounds().intersects(rectanguloPuntero)==true){return true;}
            if ( this.jLabel10.getBounds().intersects(rectanguloPuntero)==true){return true;}
            if (this.jLabel11.getBounds().intersects(rectanguloPuntero)==true){return true;}
            if (this.jLabel12.getBounds().intersects(rectanguloPuntero)==true){return true;}
            if (this.jLabel13.getBounds().intersects(rectanguloPuntero)==true){return true;}
            if (this.jLabel14.getBounds().intersects(rectanguloPuntero)==true){return true;}
        }catch(Exception e){}
    ...
    public Territorio() {
        ...
        instanciaNumero=cantidadDeInstancias;
        this.setEventos(eventos);
        rsTerritorios.add(this);
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Exagonal/medieval_windmill.png"))); // NOI18N
