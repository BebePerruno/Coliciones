 ...
 * @author Jugador
 */
public class FrmAmbienteDeJuego extends javax.swing.JFrame {

    /**
     * Creates new form FrmAmbienteDeJuego
     */
...
////        };
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmAmbienteDeJuego.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmAmbienteDeJuego().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private ExperimentosConJuegos.jPJuego jPJuego2;
